...
window.Nodue = __webpack_require__(26).boot();
...
module.exports = function () {
	...
	_createClass(Nodue, [{
		...
		value: function boot() {
			var nodue = new this();
			var bootstrapper = __webpack_require__(27);
...
module.exports = function () {
	...
	_createClass(Bootstrap, [{
		...
		value: function loadSocketIO() {
			window.io = __webpack_require__(28);
		}
	}, {
		key: 'loadjQuery',
		value: function loadjQuery() {
			window.$ = __webpack_require__(60);
		}
	}, {
		key: 'loadPretty',
		value: function loadPretty() {
			window.pretty = __webpack_require__(61).pretty;
		}
	}, {
		key: 'loadVuex',
		value: function loadVuex() {
			window.Vuex = __webpack_require__(62).default;
		}
	}, {
		key: 'loadVue',
		...
		value: function loadDeepMergeModule() {
			window.merge = __webpack_require__(64);
		}
	}, {
		...
		value: function createGlobalComponents() {
			var templates = __webpack_require__(65);
		...
		value: function createLayoutComponents() {
			var templates = __webpack_require__(66);
