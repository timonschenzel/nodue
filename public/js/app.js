...
window.Nodue = __webpack_require__(28).boot();
...
module.exports = function () {
	...
	_createClass(Nodue, [{
		...
		value: function boot() {
			var nodue = new this();
			var bootstrapper = __webpack_require__(29);
...
module.exports = function () {
	...
	_createClass(Bootstrap, [{
		...
		value: function loadjQuery() {
			window.$ = __webpack_require__(62);
		}
	}, {
		key: 'loadPretty',
		value: function loadPretty() {
			window.pretty = __webpack_require__(63).pretty;
		}
	}, {
		key: 'loadVuex',
		value: function loadVuex() {
			window.Vuex = __webpack_require__(64).default;
		}
	}, {
		key: 'loadVue',
		value: function loadVue() {
			...
			Vue.component('tic-tac-toe', __webpack_require__(69));
			Vue.component('cell', __webpack_require__(76));
		...
		value: function loadDeepMergeModule() {
			window.merge = __webpack_require__(81);
		}
	}, {
		...
		value: function createLayoutComponents() {
			var templates = __webpack_require__(83);
			...
			socket.on('response', function (response) {
				if ((typeof response === 'undefined' ? 'undefined' : _typeof(response)) === 'object') {
					...
					if (response.data.redirect) {
						...
						history.pushState({ redirect: redirect }, null, redirect);
					}
...
Component.options.__file = "packages/tic-tac-toe/src/TicTacToe.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-193abd68", Component.options)
  } else {
    hotAPI.reload("data-v-193abd68", Component.options)
  }
...
var update = __webpack_require__(24)("bed1a5ba", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-193abd68\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TicTacToe.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-193abd68\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TicTacToe.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Board__ = __webpack_require__(74);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      gameOver: false,
      gameOverText: '',
      board: new __WEBPACK_IMPORTED_MODULE_0__Board__["a" /* default */]()
    };
  },


  methods: {
    performMove: function performMove(x, y) {
      if (this.gameOver) {
        return;
      }
      ...
      var aiMove = this.minimax(this.board.clone(), 'o');
    ...
    minimax: function minimax(board, player) {
      ...
      for (var i = 0; i < moves.length; i++) {
        ...
        var score = this.minimax(newBoard, player === 'x' ? 'o' : 'x', depth + 1).score;
...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    key: 'doMove',
    value: function doMove(x, y, player) {
      if (this.cells[x][y] !== '') {
        return false;
      }
    ...
    key: 'playerHas3InARow',
    value: function playerHas3InARow(player) {
      // Horizontal rows
      for (var i = 0; i < 3; i++) {
      ...
      for (var _i = 0; _i < 3; _i++) {
        if (this.cells[_i][0] === player && this.cells[_i][1] === player && this.cells[_i][2] === player) {
          return true;
        }
      }
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
          ...
          return _c(
            ...
            _vm._l(3, function(n, j) {
              return _c(
                ...
                [
                  _c("cell", {
                    attrs: { value: _vm.board.cells[j][i] },
                    on: {
                      click: function($event) {
                        return _vm.performMove(j, i)
                      }
                    }
                  })
                ],
        ...
        _vm._v(" "),
        _vm.gameOver
          ? _c("div", { staticClass: "game-over-text" }, [
              _vm._v("\n      " + _vm._s(_vm.gameOverText) + "\n    ")
            ])
          : _vm._e()
      ],
      2
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-193abd68", module.exports)
  }
}
...
Component.options.__file = "packages/tic-tac-toe/src/Cell.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5a229a6c", Component.options)
  } else {
    hotAPI.reload("data-v-5a229a6c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(24)("eeb46c08", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a229a6c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Cell.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a229a6c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Cell.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
  ...
  return _c(
    ...
    [
      _vm.value !== ""
        ? _c(
            "span",
            { class: { red: _vm.value === "x", green: _vm.value === "o" } },
            [_vm._v("\n    " + _vm._s(_vm.value) + "\n  ")]
          )
        : _vm._e()
    ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5a229a6c", module.exports)
  }
}
